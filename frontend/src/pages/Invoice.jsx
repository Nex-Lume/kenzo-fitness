    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex justify-between items-center print:hidden">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">Download or print your payment receipt.</p>
        </div>
        <button
          onClick={handlePrint}
      ...
      <div className="bg-white text-zinc-800 rounded-2xl p-8 shadow-2xl" id="invoice">
        ...
        <div className="flex justify-between items-start border-b border-zinc-200 pb-6 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Fitness & Wellness Center</p>
          </div>
        ...
        <div className="border-b border-zinc-200 pb-6 mb-6">
          <h3 className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-4">Plan Details</h3>
            ...
            <tbody>
              <tr>
                <td className="p-3">
                  ...
                  <div className="text-xs text-gray-500">Gym access and all included features</div>
                </td>
        ...
        {/* Footer */}
        <div className="mt-8 pt-6 border-t border-zinc-200 text-center text-xs text-gray-400">
